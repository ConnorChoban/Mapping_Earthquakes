...
// 4. Use the same style as the earthquake data. //Use styleInfo like we did in the module
function styleInfo(feature) {
  return {
    opacity: 1,
    fillOpacity: 1,
...
//  after the marker has been created and styled. Use onEachFeature() in place of a for loop
L.geoJson(data, {
  pointToLayer: function(feature, latlng) {
    return L.circleMarker(latlng);
  },
